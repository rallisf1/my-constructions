...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('nuwsi' in $$props) $$invalidate(12, nuwsi = $$props.nuwsi);
		if ('xbufj' in $$props) $$invalidate(13, xbufj = $$props.xbufj);
		if ('kmodb' in $$props) $$invalidate(14, kmodb = $$props.kmodb);
		if ('xawpk' in $$props) $$invalidate(15, xawpk = $$props.xawpk);
		if ('hmbtp' in $$props) $$invalidate(16, hmbtp = $$props.hmbtp);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('nuwsi' in $$props) $$invalidate(10, nuwsi = $$props.nuwsi);
		if ('xbufj' in $$props) $$invalidate(11, xbufj = $$props.xbufj);
		if ('kmodb' in $$props) $$invalidate(12, kmodb = $$props.kmodb);
		if ('xawpk' in $$props) $$invalidate(13, xawpk = $$props.xawpk);
		if ('hmbtp' in $$props) $$invalidate(14, hmbtp = $$props.hmbtp);
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			p1 = element("p");
			p2 = element("p");
			t = text("Η σελίδα δεν βρέθηκε. Παρακαλώ χρησιμοποιείστε το μενού για να περιηγηθείτε στο site.");
			p3 = element("p");
			p4 = element("p");
			this.h();
		},
		l(nodes) {
			...
			t = claim_text(p2_nodes, "Η σελίδα δεν βρέθηκε. Παρακαλώ χρησιμοποιείστε το μενού για να περιηγηθείτε στο site.");
...
function create_fragment$7(ctx) {
	...
	component_1 = new Component$2({
			props: {
				...
				nuwsi: {},
				xbufj: {},
				kmodb: { "title": "Σφάλμα 404", "breadcrumbs": [] },
				xawpk: "<p></p><p></p><p>Η σελίδα δεν βρέθηκε. Παρακαλώ χρησιμοποιείστε το μενού για να περιηγηθείτε στο site.</p><p></p><p></p>",
				hmbtp: {},
				seo_title: "Μυτκόλλι Κατασκευαστική | Η Εταιρία",
				seo_description: "Στον χώρο της κατασκευής από το 1995 με γνωστούς πελάτες σε όλη την Ελλάδα."
			}
