...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('siwga' in $$props) $$invalidate(12, siwga = $$props.siwga);
		if ('jyigt' in $$props) $$invalidate(13, jyigt = $$props.jyigt);
		if ('dsbkc' in $$props) $$invalidate(14, dsbkc = $$props.dsbkc);
		if ('ckawe' in $$props) $$invalidate(15, ckawe = $$props.ckawe);
		if ('xjgty' in $$props) $$invalidate(16, xjgty = $$props.xjgty);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('siwga' in $$props) $$invalidate(10, siwga = $$props.siwga);
		if ('jyigt' in $$props) $$invalidate(11, jyigt = $$props.jyigt);
		if ('dsbkc' in $$props) $$invalidate(12, dsbkc = $$props.dsbkc);
		if ('ckawe' in $$props) $$invalidate(13, ckawe = $$props.ckawe);
		if ('xjgty' in $$props) $$invalidate(14, xjgty = $$props.xjgty);
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			t0 = text("ΓΝΩΡΙΣΤΕ ΜΑΣ!");
			h11 = element("h1");
			p1 = element("p");
			t1 = text("Είμαστε στο χώρο της κατασκευής με ένα εξαιρετικό προσωπικό και πολυετή εμπειρία.");
			p2 = element("p");
			t2 = text("Από το 1995, ασχολούμαστε με:");
			ul = element("ul");
			li0 = element("li");
			p3 = element("p");
			strong1 = element("strong");
			t3 = text("βιομηχανικά δάπεδα,");
			li1 = element("li");
			p4 = element("p");
			...
			t7 = text("στεγανοποιήσεις");
			li5 = element("li");
			p8 = element("p");
			strong6 = element("strong");
			t8 = text("και εξωτερικές θερμομονώσεις.");
			p9 = element("p");
			t9 = text("Ό,τι και αν έχετε στον νου σας, οι ειδικοί μας θα το κατασκευάσουν.");
			p10 = element("p");
			a = element("a");
			t10 = text("Επικοινωνήστε μαζί μας");
			t11 = text(" για μια προσφορά!");
			p11 = element("p");
			p12 = element("p");
			this.h();
		},
		l(nodes) {
			...
			strong0 = claim_element(h10_nodes, "STRONG", {});
			var strong0_nodes = children(strong0);
			t0 = claim_text(strong0_nodes, "ΓΝΩΡΙΣΤΕ ΜΑΣ!");
			strong0_nodes.forEach(detach);
			h10_nodes.forEach(detach);
			h11 = claim_element(div0_nodes, "H1", {});
			children(h11).forEach(detach);
			p1 = claim_element(div0_nodes, "P", {});
			var p1_nodes = children(p1);
			t1 = claim_text(p1_nodes, "Είμαστε στο χώρο της κατασκευής με ένα εξαιρετικό προσωπικό και πολυετή εμπειρία.");
			p1_nodes.forEach(detach);
			p2 = claim_element(div0_nodes, "P", {});
			var p2_nodes = children(p2);
			t2 = claim_text(p2_nodes, "Από το 1995, ασχολούμαστε με:");
			...
			t3 = claim_text(strong1_nodes, "βιομηχανικά δάπεδα,");
			...
			t4 = claim_text(strong2_nodes, "ράμπες,");
			...
			t9 = claim_text(p9_nodes, "Ό,τι και αν έχετε στον νου σας, οι ειδικοί μας θα το κατασκευάσουν.");
			p9_nodes.forEach(detach);
			p10 = claim_element(div0_nodes, "P", {});
			var p10_nodes = children(p10);

			a = claim_element(p10_nodes, "A", {
				target: true,
				rel: true,
				class: true,
				href: true
			...
			var a_nodes = children(a);
			t10 = claim_text(a_nodes, "Επικοινωνήστε μαζί μας");
			a_nodes.forEach(detach);
			t11 = claim_text(p10_nodes, " για μια προσφορά!");
			p10_nodes.forEach(detach);
			p11 = claim_element(div0_nodes, "P", {});
			children(p11).forEach(detach);
			p12 = claim_element(div0_nodes, "P", {});
			children(p12).forEach(detach);
			div0_nodes.forEach(detach);
			div1_nodes.forEach(detach);
			this.h();
		},
		h() {
			...
			attr(a, "rel", "noopener noreferrer nofollow");
			attr(a, "class", "link link link link");
			attr(a, "href", "https://www.myconstructions.gr/epikoinonia");
		...
		m(target, anchor) {
			...
			append_hydration(div0, ul);
			append_hydration(ul, li0);
			append_hydration(li0, p3);
			append_hydration(p3, strong1);
			append_hydration(strong1, t3);
			append_hydration(ul, li1);
			append_hydration(li1, p4);
			append_hydration(p4, strong2);
			append_hydration(strong2, t4);
			append_hydration(ul, li2);
			append_hydration(li2, p5);
			append_hydration(p5, strong3);
			append_hydration(strong3, t5);
			append_hydration(ul, li3);
			append_hydration(li3, p6);
			append_hydration(p6, strong4);
			append_hydration(strong4, t6);
			append_hydration(ul, li4);
			append_hydration(li4, p7);
			append_hydration(p7, strong5);
			append_hydration(strong5, t7);
			append_hydration(ul, li5);
			append_hydration(li5, p8);
			append_hydration(p8, strong6);
			append_hydration(strong6, t8);
			append_hydration(div0, p9);
			append_hydration(p9, t9);
			append_hydration(div0, p10);
			append_hydration(p10, a);
...
function create_fragment$7(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				breadcrumbs: [],
				phone2: "6937 2790 96",
				seo_title: "Μυτκόλλι Κατασκευαστική | Η Εταιρία",
				seo_description: "Στον χώρο της κατασκευής από το 1995 με γνωστούς πελάτες σε όλη την Ελλάδα."
			}
		});
	...
	component_1 = new Component$2({
			props: {
				...
				siwga: {},
				jyigt: {},
				dsbkc: { "title": "Η εταιρία", "breadcrumbs": [] },
				ckawe: {},
				xjgty: "<p></p><h1><strong>ΓΝΩΡΙΣΤΕ ΜΑΣ!</strong></h1><h1></h1><p>Είμαστε στο χώρο της κατασκευής με ένα εξαιρετικό προσωπικό και πολυετή εμπειρία.</p><p>Από το 1995, ασχολούμαστε με:</p><ul><li><p><strong>βιομηχανικά δάπεδα,</strong></p></li><li><p><strong>ράμπες,</strong></p></li><li><p><strong>σταμπωτά,</strong></p></li><li><p><strong>μονώσεις,</strong></p></li><li><p><strong>στεγανοποιήσεις</strong></p></li><li><p><strong>και εξωτερικές θερμομονώσεις.</strong></p></li></ul><p>Ό,τι και αν έχετε στον νου σας, οι ειδικοί μας θα το κατασκευάσουν.</p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"https://www.myconstructions.gr/epikoinonia\">Επικοινωνήστε μαζί μας</a> για μια προσφορά!</p><p></p><p></p>",
				seo_title: "Μυτκόλλι Κατασκευαστική | Η Εταιρία",
				seo_description: "Στον χώρο της κατασκευής από το 1995 με γνωστούς πελάτες σε όλη την Ελλάδα."
			}
		});
