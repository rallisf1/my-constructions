...
function create_each_block(ctx) {
	...
	icon = new Component$1({
			props: { icon: /*s*/ ctx[19].icon, height: "20" }
		});
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*s*/ ctx[19].link);
			attr(a, "title", a_title_value = /*s*/ ctx[19].title);
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social*/ 2) icon_changes.icon = /*s*/ ctx[19].icon;
			icon.$set(icon_changes);

			if (!current || dirty & /*social*/ 2 && a_href_value !== (a_href_value = /*s*/ ctx[19].link)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social*/ 2 && a_title_value !== (a_title_value = /*s*/ ctx[19].title)) {
...
function create_fragment$2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(a1, "click", prevent_default(/*click_handler*/ ctx[18]));
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('mnllo' in $$props) $$invalidate(12, mnllo = $$props.mnllo);
		if ('hurnv' in $$props) $$invalidate(13, hurnv = $$props.hurnv);
		if ('btzpd' in $$props) $$invalidate(14, btzpd = $$props.btzpd);
		if ('nunib' in $$props) $$invalidate(15, nunib = $$props.nunib);
		if ('seo_title' in $$props) $$invalidate(16, seo_title = $$props.seo_title);
		if ('seo_description' in $$props) $$invalidate(17, seo_description = $$props.seo_description);
	};
...
// (277:10) {#if item.submenu && item.submenu.length}
function create_if_block_1$1(ctx) {
	let ul;
	let each_value_4 = /*item*/ ctx[25].submenu;
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(ul, "class", "submenu svelte-1ekzptq");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1) {
				each_value_4 = /*item*/ ctx[25].submenu;
				let i;
...
// (279:10) {#each item.submenu as subitem}
function create_each_block_4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "sublink svelte-1ekzptq");
			attr(li, "class", "svelte-1ekzptq");
		},
		m(target, anchor) {
...
// (274:6) {#each nav as item}
function create_each_block_3(ctx) {
	let li;
	let a;
	let t0_value = /*item*/ ctx[25].link.label + "";
	let t0;
	let a_href_value;
	let t1;
	let t2;
	let if_block = /*item*/ ctx[25].submenu && /*item*/ ctx[25].submenu.length && create_if_block_1$1(ctx);
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*item*/ ctx[25].link.url);
			attr(a, "class", "link svelte-1ekzptq");
			attr(li, "class", "svelte-1ekzptq");
		},
		m(target, anchor) {
			insert_hydration(target, li, anchor);
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1 && t0_value !== (t0_value = /*item*/ ctx[25].link.label + "")) set_data(t0, t0_value);

			if (dirty & /*nav*/ 1 && a_href_value !== (a_href_value = /*item*/ ctx[25].link.url)) {
				attr(a, "href", a_href_value);
			}

			if (/*item*/ ctx[25].submenu && /*item*/ ctx[25].submenu.length) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "button inverted svelte-1ekzptq");
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
			append_hydration(a, t);
		...
		p(ctx, dirty) {
			if (dirty & /*cta*/ 2 && t_value !== (t_value = /*link*/ ctx[19].label + "")) set_data(t, t_value);

			if (dirty & /*cta*/ 2 && a_href_value !== (a_href_value = /*link*/ ctx[19].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_if_block$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(rect0, "class", "st2 svelte-1ekzptq");
			attr(rect0, "x", "1436.9");
			attr(rect0, "y", "24.6");
			attr(rect0, "width", "25.4");
			attr(rect0, "height", "39.4");
			attr(path0, "class", "st0 svelte-1ekzptq");
			...
			attr(path1, "class", "st0 svelte-1ekzptq");
			...
			attr(path2, "class", "st0 svelte-1ekzptq");
			...
			attr(path3, "class", "st0 svelte-1ekzptq");
			...
			attr(path4, "class", "st0 svelte-1ekzptq");
			...
			attr(path5, "class", "st0 svelte-1ekzptq");
			...
			attr(path6, "class", "st0 svelte-1ekzptq");
			...
			attr(path7, "class", "st0 svelte-1ekzptq");
			...
			attr(path8, "class", "st0 svelte-1ekzptq");
			...
			attr(path11, "class", "st0 svelte-1ekzptq");
			...
			attr(svg0, "class", "svelte-1ekzptq");
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-1ekzptq");
			attr(hr, "class", "svelte-1ekzptq");
			...
			attr(svg1, "class", "svelte-1ekzptq");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-1ekzptq");
			attr(nav_1, "id", "mobile-nav");
			attr(nav_1, "class", "svelte-1ekzptq");
		},
		m(target, anchor) {
...
function create_each_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1 && t_value !== (t_value = /*link*/ ctx[19].label + "")) set_data(t, t_value);
...
function create_each_block$1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*link*/ ctx[19].url);
			attr(a, "class", "svelte-1ekzptq");
			toggle_class(a, "button", /*cta*/ ctx[1].length - 1 === /*i*/ ctx[21]);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
			append_hydration(a, t);
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1ekzptq");
			attr(div0, "class", "call-to-action svelte-1ekzptq");
			attr(div1, "class", "section-container svelte-1ekzptq");
			attr(header, "id", "nav");
			attr(header, "class", "svelte-1ekzptq");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('mnllo' in $$props) $$invalidate(10, mnllo = $$props.mnllo);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			if (!src_url_equal(iframe.src, iframe_src_value = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3143.672940610186!2d23.86227791559742!3d38.00808850647402!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14a19bd38a5fd783%3A0x1ba489ae294dad58!2zzqDOuc61z4HOr86xz4IgMjEsIM6Tzq3Pgc6xzrrOsc-CIDE1MyA0NA!5e0!3m2!1sel!2sgr!4v1652377966889!5m2!1sel!2sgr")) attr(iframe, "src", iframe_src_value);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('mnllo' in $$props) $$invalidate(9, mnllo = $$props.mnllo);
		if ('hurnv' in $$props) $$invalidate(10, hurnv = $$props.hurnv);
		if ('btzpd' in $$props) $$invalidate(11, btzpd = $$props.btzpd);
		if ('nunib' in $$props) $$invalidate(12, nunib = $$props.nunib);
...
function create_if_block_1$2(ctx) {
	...
	let t1;
	let a;
	let t2_value = /*branch*/ ctx[21].phone + "";
	let t2;
	let a_href_value;
	...
	return {
		...
		l(nodes) {
			...
			t0 = claim_text(strong_nodes, "Τηλέφωνο:");
		...
		h() {
			attr(strong, "class", "svelte-1tuhct5");
			attr(a, "href", a_href_value = "tel:" + /*branch*/ ctx[21].phone.split(' ').join(''));
			attr(a, "class", "svelte-1tuhct5");
			attr(p, "class", "svelte-1tuhct5");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*branches*/ 8 && t2_value !== (t2_value = /*branch*/ ctx[21].phone + "")) set_data(t2, t2_value);

			if (dirty & /*branches*/ 8 && a_href_value !== (a_href_value = "tel:" + /*branch*/ ctx[21].phone.split(' ').join(''))) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_if_block$2(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			strong = claim_element(p_nodes, "STRONG", { class: true });
			var strong_nodes = children(strong);
			t0 = claim_text(strong_nodes, "Email:");
			strong_nodes.forEach(detach);
			t1 = claim_space(p_nodes);
		...
		h() {
			attr(strong, "class", "svelte-1tuhct5");
			attr(a, "href", a_href_value = "#");
			attr(a, "title", "Στείλτε μας email");
			attr(a, "class", "cryptedmail svelte-1tuhct5");
			attr(a, "data-name", /*to*/ ctx[4]);
			attr(a, "data-domain", /*domain*/ ctx[5]);
			attr(a, "data-tld", /*tld*/ ctx[6]);
			attr(p, "class", "svelte-1tuhct5");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			...
			if (!mounted) {
				dispose = listen(a, "click", prevent_default(/*click_handler_1*/ ctx[20]));
				mounted = true;
			}
		},
		p: noop,
...
// (113:4) {#each branches as branch}
function create_each_block$2(ctx) {
	let div;
	let h3;
	let t0_value = /*branch*/ ctx[21].title + "";
	let t0;
	let t1;
	let p;
	let t2_value = /*branch*/ ctx[21].address + "";
	let t2;
	let t3;
	let t4;
	let t5;
	let if_block0 = /*branch*/ ctx[21].phone && create_if_block_1$2(ctx);
	let if_block1 = /*branch*/ ctx[21].email && create_if_block$2(ctx);
	...
	return {
		...
		h() {
			attr(h3, "class", "svelte-1tuhct5");
			attr(p, "class", "svelte-1tuhct5");
			attr(div, "class", "svelte-1tuhct5");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*branches*/ 8 && t0_value !== (t0_value = /*branch*/ ctx[21].title + "")) set_data(t0, t0_value);
			if (dirty & /*branches*/ 8 && t2_value !== (t2_value = /*branch*/ ctx[21].address + "")) set_data(t2, t2_value);

			if (/*branch*/ ctx[21].phone) {
				if (if_block0) {
...
function create_fragment$5(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			var h3_nodes = children(h3);
			t0 = claim_text(h3_nodes, "Κεντρικά");
			h3_nodes.forEach(detach);
			t1 = claim_space(div0_nodes);
			p0 = claim_element(div0_nodes, "P", { class: true });
			var p0_nodes = children(p0);
			t2 = claim_text(p0_nodes, /*address*/ ctx[0]);
			p0_nodes.forEach(detach);
			t3 = claim_space(div0_nodes);
			p1 = claim_element(div0_nodes, "P", { class: true });
			var p1_nodes = children(p1);
			strong0 = claim_element(p1_nodes, "STRONG", { class: true });
			var strong0_nodes = children(strong0);
			t4 = claim_text(strong0_nodes, "Τηλέφωνο:");
			strong0_nodes.forEach(detach);
			t5 = claim_space(p1_nodes);
			a0 = claim_element(p1_nodes, "A", { href: true, class: true });
			var a0_nodes = children(a0);
			t6 = claim_text(a0_nodes, /*phone*/ ctx[1]);
			a0_nodes.forEach(detach);
			t7 = claim_text(p1_nodes, ", ");
			a1 = claim_element(p1_nodes, "A", { href: true, class: true });
			var a1_nodes = children(a1);
			t8 = claim_text(a1_nodes, /*phone2*/ ctx[2]);
			a1_nodes.forEach(detach);
			...
			t10 = claim_text(strong1_nodes, "Email:");
			...
			var button_nodes = children(button);
			t23 = claim_text(button_nodes, "Αποστολή");
			button_nodes.forEach(detach);
		...
		h() {
			attr(h3, "class", "svelte-1tuhct5");
			attr(p0, "class", "svelte-1tuhct5");
			attr(strong0, "class", "svelte-1tuhct5");
			attr(a0, "href", a0_href_value = "tel:" + /*phone*/ ctx[1].split(' ').join(''));
			attr(a0, "class", "svelte-1tuhct5");
			attr(a1, "href", a1_href_value = "tel:" + /*phone2*/ ctx[2].split(' ').join(''));
			attr(a1, "class", "svelte-1tuhct5");
			attr(p1, "class", "svelte-1tuhct5");
			attr(strong1, "class", "svelte-1tuhct5");
			attr(a2, "href", a2_href_value = "#");
			attr(a2, "title", "Στείλτε μας email");
			attr(a2, "class", "cryptedmail svelte-1tuhct5");
			attr(a2, "data-name", /*to*/ ctx[4]);
			attr(a2, "data-domain", /*domain*/ ctx[5]);
			attr(a2, "data-tld", /*tld*/ ctx[6]);
			attr(p2, "class", "svelte-1tuhct5");
			attr(div0, "class", "svelte-1tuhct5");
			attr(div1, "class", "branches svelte-1tuhct5");
			attr(input0, "type", "hidden");
			attr(input0, "name", "_to");
			input0.value = "mytkolli_ee@yahoo.com";
			attr(input0, "class", "svelte-1tuhct5");
			attr(input1, "type", "hidden");
			attr(input1, "name", "_formName");
			input1.value = "Επικοινωνία από myconstructions.gr";
			attr(input1, "class", "svelte-1tuhct5");
			attr(input2, "type", "hidden");
			attr(input2, "name", "_redirectTo");
			input2.value = "https://www.myconstructions.gr/";
			attr(input2, "class", "svelte-1tuhct5");
			attr(input3, "id", "TEmail");
			attr(input3, "type", "email");
			attr(input3, "name", "_t_email");
			set_style(input3, "display", "none");
			attr(input3, "class", "svelte-1tuhct5");
			attr(input4, "type", "text");
			attr(input4, "name", "Name");
			attr(input4, "placeholder", "Ονοματεπώνυμο *");
			input4.required = true;
			attr(input4, "class", "svelte-1tuhct5");
			attr(input5, "type", "text");
			attr(input5, "name", "Phone");
			attr(input5, "placeholder", "Τηλέφωνο *");
			input5.required = true;
			attr(input5, "class", "svelte-1tuhct5");
			attr(input6, "type", "email");
			attr(input6, "name", "_replyTo");
			attr(input6, "placeholder", "Email *");
			input6.required = true;
			attr(input6, "class", "svelte-1tuhct5");
			attr(textarea, "name", "Message");
			attr(textarea, "placeholder", "Το μήνυμα σας *");
			textarea.required = true;
			attr(textarea, "class", "svelte-1tuhct5");
			attr(button, "class", "button svelte-1tuhct5");
			attr(button, "type", "submit");
			attr(form, "action", "https://mailgate.dws.gr");
			attr(form, "method", "post");
			attr(form, "class", "svelte-1tuhct5");
			attr(section, "class", "section-container svelte-1tuhct5");
			attr(div2, "class", "component svelte-1tuhct5");
			attr(div3, "class", "section has-component svelte-1tuhct5");
			attr(div3, "id", "nunib");
		},
		m(target, anchor) {
			insert_hydration(target, div3, anchor);
			...
			if (!mounted) {
				dispose = listen(a2, "click", prevent_default(/*click_handler*/ ctx[19]));
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
			if (dirty & /*address*/ 1) set_data(t2, /*address*/ ctx[0]);
			if (dirty & /*phone*/ 2) set_data(t6, /*phone*/ ctx[1]);

			if (dirty & /*phone*/ 2 && a0_href_value !== (a0_href_value = "tel:" + /*phone*/ ctx[1].split(' ').join(''))) {
				attr(a0, "href", a0_href_value);
			}

			if (dirty & /*phone2*/ 4) set_data(t8, /*phone2*/ ctx[2]);

			if (dirty & /*phone2*/ 4 && a1_href_value !== (a1_href_value = "tel:" + /*phone2*/ ctx[2].split(' ').join(''))) {
				attr(a1, "href", a1_href_value);
			}

			if (dirty & /*to, domain, tld, handleMailLink, branches*/ 120) {
				each_value = /*branches*/ ctx[3];
				let i;
...
function instance$5($$self, $$props, $$invalidate) {
	...
	let { branches } = $$props;
	const [to, domain, tld] = [...email.split(/[@\.]/)];
	const click_handler = e => handleMailLink$1(e);
	const click_handler_1 = e => handleMailLink$1(e);
	...
	$$self.$$set = $$props => {
		...
		if ('nav' in $$props) $$invalidate(10, nav = $$props.nav);
		if ('cta' in $$props) $$invalidate(11, cta = $$props.cta);
		if ('breadcrumbs' in $$props) $$invalidate(12, breadcrumbs = $$props.breadcrumbs);
		if ('phone2' in $$props) $$invalidate(2, phone2 = $$props.phone2);
		if ('mnllo' in $$props) $$invalidate(13, mnllo = $$props.mnllo);
		if ('hurnv' in $$props) $$invalidate(14, hurnv = $$props.hurnv);
		if ('btzpd' in $$props) $$invalidate(15, btzpd = $$props.btzpd);
		if ('nunib' in $$props) $$invalidate(16, nunib = $$props.nunib);
		...
		if ('branches' in $$props) $$invalidate(3, branches = $$props.branches);
	};
...
function get_each_context$3(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[19] = list[i].link;
	child_ctx[20] = list[i].submenu;
	return child_ctx;
}

function get_each_context_1$1(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[23] = list[i].sublink;
	return child_ctx;
}

// (141:8) {#each submenu as {sublink}}
function create_each_block_1$1(ctx) {
	let li;
	let a;
	let t_value = /*sublink*/ ctx[23].label + "";
	let t;
	let a_href_value;
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*sublink*/ ctx[23].url);
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 8 && t_value !== (t_value = /*sublink*/ ctx[23].label + "")) set_data(t, t_value);

			if (dirty & /*nav*/ 8 && a_href_value !== (a_href_value = /*sublink*/ ctx[23].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
// (140:8) {#each nav as {link, submenu}}
function create_each_block$3(ctx) {
	let each_1_anchor;
	let each_value_1 = /*submenu*/ ctx[20];
	let each_blocks = [];
...
function create_fragment$7(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				breadcrumbs: [],
				phone2: "6937 2790 96",
				seo_title: "Μυτκόλλι Κατασκευαστική | Επικοινωνία",
				seo_description: "Επικοινωνήστε μαζί μας για προσφορές & εκτιμήσεις εργασιών κατασκευής ή ανακαίνισης"
			}
		});
			...
			props: {
				...
				nunib: {
					"branches": [
						{
							"title": "Αποθήκες",
							"address": "ΔΑΒΑΚΗ ΠΙΝΔΟΥ 39, 17236, ΥΜΗΤΤΟΣ",
							"phone": "",
							"email": ""
						}
					]
